...
import './App.css'; // Assuming you have a CSS file for styles (e.g., About.css)
import 'animate.css';
import WOW from 'wow.js'; // Import WOW.js for triggering animations
import Footer from './Footer';
import FoodMenu from './FoodMenu';
import Ourmenu from './Ourmenu';
const About = () => {
  useEffect(() => {
    // Initialize WOW.js to trigger animations
    new WOW().init();
  }, []);
